...
const unsigned fwConfigs_OBJECT_DATA_TYPE = 1;

//dpeAlertConfigObject

// Common indexes to all configs
const unsigned fwConfigs_DPE_OBJECT_DPE_NAME	= 1;
const unsigned fwConfigs_DPE_OBJECT_DPE_TYPE	= 2;
const unsigned fwConfigs_DPE_OBJECT_TYPE		= 3;
const unsigned fwConfigs_DPE_OBJECT_ACTIVE	= 4;
...
const unsigned fwPeriphAddress_DPE_OBJECT_OPCUA_LOWLEVEL					= 11;
const unsigned fwPeriphAddress_DPE_OBJECT_OPCUA_SERVER_NAME			= 12;
const unsigned fwPeriphAddress_DPE_OBJECT_OPCUA_SUBSCRIPTION			= 13;
const unsigned fwPeriphAddress_DPE_OBJECT_OPCUA_KIND								= 14;
const unsigned fwPeriphAddress_DPE_OBJECT_OPCUA_VARIANT						= 15;
const unsigned fwPeriphAddress_DPE_OBJECT_OPCUA_POLL_GROUP				= 16;
...
const unsigned fwAlertConfig_DPE_OBJECT_LIMITS			= 5;
const unsigned fwAlertConfig_DPE_OBJECT_CLASSES			= 6;
const unsigned fwAlertConfig_DPE_OBJECT_TEXTS				= 7;
const unsigned fwAlertConfig_DPE_OBJECT_PANEL				= 8;
const unsigned fwAlertConfig_DPE_OBJECT_PANEL_PARAMETERS	= 9;
const unsigned fwAlertConfig_DPE_OBJECT_HELP				= 10;
...
const unsigned fwArchive_DPE_OBJECT_PROCEDURE 	= 5;
const unsigned fwArchive_DPE_OBJECT_DEADBAND		= 6;
const unsigned fwArchive_DPE_OBJECT_TIME_INTERVAL	= 7;
const unsigned fwArchive_DPE_OBJECT_CLASS_NAME	= 8;

// Specific constants for DP function
const unsigned fwDpFunction_DPE_OBJECT_FUNCTION 	= 5;
const unsigned fwDpFunction_DPE_OBJECT_PARAMETERS	= 6;
const unsigned fwDpFunction_DPE_OBJECT_GLOBALS	= 7;

// Specific indexes for smooth
const unsigned fwSmoothing_DPE_OBJECT_PROCEDURE 		= 5;
const unsigned fwSmoothing_DPE_OBJECT_DEADBAND		= 6;
const unsigned fwSmoothing_DPE_OBJECT_TIME_INTERVAL	= 7;

// Specific indexes for conversion
const unsigned fwConversion_DPE_OBJECT_TYPE 			= 5;
const unsigned fwConversion_DPE_OBJECT_CONV_TYPE 		= 6;
const unsigned fwConversion_DPE_OBJECT_ORDER 			= 7;
const unsigned fwConversion_DPE_OBJECT_ARGUMENTS		= 8;
...
const unsigned fwPvRange_DPE_OBJECT_MIN_VALUE			= 5;
const unsigned fwPvRange_DPE_OBJECT_MAX_VALUE			= 6;
const unsigned fwPvRange_DPE_OBJECT_NEGATE_RANGE		= 7;
const unsigned fwPvRange_DPE_OBJECT_IGNORE_OUTSIDE	= 8;
const unsigned fwPvRange_DPE_OBJECT_INCLUSIVE_MIN		= 9;
const unsigned fwPvRange_DPE_OBJECT_INCLUSIVE_MAX		= 10;

// Specific indexes for format
const unsigned fwFormat_DPE_OBJECT_FORMAT = 5;

// Specific indexes for unit
const unsigned fwUnit_DPE_OBJECT_UNIT = 5;
