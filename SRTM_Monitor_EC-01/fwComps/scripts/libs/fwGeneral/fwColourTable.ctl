...
void fwColourTable_connectCellBackColToStatus(dyn_string &exceptionInfo)
{
 ...
 */
void _fwColourTable_calculateColourWithAlertCB( string dpe1, string alertColour, string dpe2,
...
/** @internal @private
   ...
   @param dataInvalid a bit to represent if data is invalid or not (TRUE = invalid, FALSE = valid)
 */
void _fwColourTable_calculateColourWithoutAlertCB(string dpe1, bool dataInvalid)
{
	string elementColour, dpName;
	dyn_string exceptionInfo;
	int cellPos;
...
/**This function controls the background colour of the cell of a table from within which the function was called.
   ...
   @param exceptionInfo details of any exceptions are placed in here.
 */
void fwColourTable_connectCellBackColToValueStatus(dyn_string &exceptionInfo)
{
	int configType, len, cellPos, i, iResType;
	string dpe;
 ...
 */
void _fwColourTable_calculateColourWithAlertCBValue(    string dpe1, string alertColour, string dpe2,
														bool alarmActive, string dpe3, bool dataInvalid,
 ...
 */
void _fwColourTable_calculateColourWithoutAlertCBValue( string dpe1, bool dataInvalid,
 ...
 */
void _fwColourTable_calculateColourWithSummaryAlertCB(  string dpe1, string alertColour,
