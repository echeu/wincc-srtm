...
/** This function returns post install files that are scheduled to run
  ...
  * @return 0 - "success"  -1 - error
  * @author S. Schmeling
  * @deprecated 2024-02-06
  */
int fwInstallation_postInstallToRun(dyn_string & allPostInstallFiles)
{
  fwInstallation_flagDeprecated("fwInstallation_postInstallToRun");
...
{
  fwInstallation_flagDeprecated("fwInstallation_getProjectPendingPostInstalls");
...
/** This function sets the idle DB connection timeout to the default value
  * @note Marked to deprecated as the CtrlRdbAccess option this funtion uses was never? effective
  * @return 0 if OK, -1 if error
  * @deprecated 2024-11-12
*/
int fwInstallationDB_setConnectionTimeout()
{
  fwInstallation_flagDeprecated("fwInstallationDB_setConnectionTimeout");
